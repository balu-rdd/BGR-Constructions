...
<div class="pt-24">
    ...
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-3/5 justify-center items-start text-center md:text-left">
            <h1 class="my-4 text-5xl font-bold leading-tight">Our Services</h1>
        ...
        <div class="w-full md:w-2/5 py-6 text-center">
            <img class="w-full md:w-4/5 z-50" src="{{asset('assets/1278282139.svg')}}">
        </div>
...
<section class="bg-white border-b py-8">
    <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
            <div class="w-5/6 sm:w-1/2 p-6">
                ...
                <ul class="list-disc text-gray-700">
                    <li>
                        Excavation of hard rocks, Diamond wire saw method
                    </li>
                    <li>
                        Excavation of Soils for land leveling
                    </li>
                    <li>
                        Retaining wall & Stone pitching
                    </li>
                </ul>
                <br /><br />
                            ...
                            <button type="button" class="w-full px-8 py-6 text-left"
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="accord-heading">
                                        Excavation of Hard rocks, Diamond wire saw method </span>
                            ...
                            <div class="relative overflow-hidden transition-all max-h-0 duration-700" style=""
                                ...
                                <div class="p-6">
                                    <p class="text-base antialiased font-normal tracking-wide leading-7 text-justify">
                                        ...
                                        services. Make a hole on the rock by using of LD BORE MACHINE WITH 4”
                                        Diameter both the side of the rocks and then cutting the rocks in Bottom and
                                        Vertical direction by the use of DIAMOND WIRE SAW ROPE MACHINE.
                                    </p>
                                    <ul class="list-decimal list-inside ">
                                        <li
                                            class="text-base antialiased font-normal tracking-wide leading-7 py-2 text-justify">
                                            <strong> Drilling holes: </strong> using tractor/air compressors –
                                            between 25mm and
                                            32mm
                                            dia,
                                            giving 9 inch space between holes. 2.5 feet line spacing, vertical
                                            and
                                            or
                                            horizontal in case of repetition. Drilling Depth must be minimum of
                                            50%
                                            (Rock) of the required depth as planned at site.
                                        </li>
                                        <li
                                            class="text-base antialiased font-normal tracking-wide leading-7 py-2 text-justify">
                                            <strong>Filling holes with chemical</strong> – 1.5ltrs of water should
                                            be added and
                                            mixed
                                            for
                                            every 5 kg pack of chemical. Recommended time to pore the chemical
                                            will
                                            be
                                            only after sunset / 6.00 pm onwards. Chemical should be filled in
                                            the
                                            holes
                                            immediately on mixing in order to avoid burning. Work should be well
                                            planned
                                            before starting these activities, and workers should come out from
                                            the
                                            site,
                                            as the possibilities of blowing of chemical is more. Available
                                            quality
                                            brands: Crack AG, Split AG, and Mansi. Chemical stock should be
                                            stored
                                            at
                                            cool place and keep away from the water Result: Development of
                                            cracks
                                            can be
                                        </li> identifies after 3 hours.
                                        <li
                                            class="text-base antialiased font-normal tracking-wide leading-7 py-2 text-justify">
                                            <strong>Breaking and separating:</strong> Breaking and separating of the
                                            rock can be
                                            done
                                            using hydraulic breakers.</li>
                                    </ul>
                                    <p
                                        class="text-base antialiased font-normal tracking-wide leading-7 py-2 text-justify">
                                        Company makes every possible efforts for minimizing adverse impacts of
                                        Cutting operations on the local ecology.
                                    </p>
                                    <p
                                        class="text-base antialiased font-normal tracking-wide leading-7 py-2 text-justify">
                                        ...
                                        recognition for providing effective specialized Civil Engineering
                                        Solutions.</p>
                                </div>
                            </div>
            ...
            <div class="w-full sm:w-1/2 p-6">
                <div class="w-full sm:h-64 mx-auto bg-no-repeat bg-center "
                    style="background-image: url('assets/mountains-with-waterfall.svg')">
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
            ...
            <div class="w-full sm:w-1/2 p-6 mt-6">
                <div class="align-middle">
                    <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">CONSTRUCTION PROJECTS</h3>
                    <p class="text-gray-600 mb-8">
                        <br>
                        <strong class="text-xl font-bold">Industrial Sheds</strong>
                        <br>
                        <br>
                        The company serves its customers at every project phase, from strategy formulation through
                                ...
                                <div class="relative overflow-hidden transition-all max-h-0 duration-700" style=""
                                    ...
                                    <div class="p-6">
                                        ...
                                        <ul class="list-none list-inside ">
                                            ...
                                            <li>
                                                3.8 Concrete and concrete test.
                                            </li>
                                            <li>
                                                3.9 Backfilling and soil test.
                                            </li>
                                            <li>
                                                3.10 Finishing
                                            </li>
                                            <li>
                                                3.11 Tiles and Gypsum
                                            </li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full sm:w-1/2 p-6">
                <div class="w-full sm:h-64 mx-auto bg-no-repeat bg-center "
                    style="background-image: url('assets/RoadRoller.svg')">
                </div>
            </div>
        </div>
